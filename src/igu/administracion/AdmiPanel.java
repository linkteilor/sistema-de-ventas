 ...
 * @author Asullom
 */
public class AdmiPanel extends javax.swing.JPanel {

    AdminTableModel clientesTableModel = new AdminTableModel();
    ...
    private void paintTable(AdminTableModel tableModel) {
    ...
    private void paintForm() {
        if (table.getSelectedRow() != -1) {
            ...
            infoadic.setText(d.getTelefono());
    ...
    private void guardarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarButtonActionPerformed
        ...
        if (this.nombres.getText().equals("")) {
            ...
            s.setTelefono(infoadic.getText());
            if (table.getSelectedRow() != -1) {// ha seleccionado, update
                try {
                    ...
                    if (s.getIdcliente() > 0) {
                        ...
                        if (returnId != 0) {
                            paintTable(new AdminTableModel());
                            resetForm();
    ...
    private void buscarFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarFieldKeyReleased
        // TODO add your handling code here:
        AdminTableModel tableModel = new AdminTableModel(buscarField.getText());
    ...
    private void theButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_theButton4ActionPerformed
        ...
        try {
            ...
            ErrorLogger.log(Level.SEVERE, AdmiPanel.class.getName() + ".ExportarExcel", ex);
