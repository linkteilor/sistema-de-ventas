...
public class ClientesPanel extends javax.swing.JPanel {
    ...
    private void paintForm() {
        if (table.getSelectedRow() != -1) {
            ...
            Cliente d = CienteData.getByPId(filax.getIdcliente());
            telefonotxt.setText(d.getNombre());
            infotxt.setText(d.getTelefono());
            System.out.printf("getIdcliente:%d getSelectedRow:%d \n", d.getIdcliente(), table.getSelectedRow());
    ...
    private void initComponents() {
        ...
        infotxt.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        infotxt.setRows(5);
        ...
        sexotxt.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Masculino", "Femenino", "Otro" }));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel8Layout.createSequentialGroup()
                                ...
                                .addComponent(apellidotxt, javax.swing.GroupLayout.PREFERRED_SIZE, 285, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(3, 3, 3))
                            .addGroup(jPanel8Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(telefonotxt, javax.swing.GroupLayout.PREFERRED_SIZE, 285, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel10)
                    .addComponent(sexotxt, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(21, 21, 21)
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel11)
        ...
        if (table.getSelectedRow() != -1) {
            try {
                ...
                if (opc == JOptionPane.OK_OPTION) {
                    Cliente fila = (Cliente) clientesTableModel.getRow(table.getSelectedRow());
                    System.out.printf("eliminarButtonActionPerformed getIdcliente:%d getSelectedRow:%d \n", fila.getIdcliente(), table.getSelectedRow());

                    int opcion = CienteData.delete(fila.getIdcliente());
                    if (opcion != 0) {
